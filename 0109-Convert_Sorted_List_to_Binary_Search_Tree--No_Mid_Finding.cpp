...
private:
     ...
     * @params head pointer to pointer to head of linked list
     * @params height number of fully-filled layers of subtree
     * @params nlast pointer to number of leaves in last partially-filled layer
     **/
